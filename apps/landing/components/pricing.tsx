...
const plans = [
  {
    ...
    features: ["1 repo", "All static analyzers", "Live TUI dashboard", "CLI gate for CI", "Community support"],
    cta: "Get Started Free",
    highlighted: false,
  },
  {
    name: "Team",
    description: "For teams shipping AI-assisted code",
